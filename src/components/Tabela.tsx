...
export default function Tabela(props: TabelaProps) {
  const exibirAcores = props.clienteExcluido || props.clienteSelecionado
  function rendCabecalho() {
    return (
      <tr>
        ...
        {exibirAcores ? <th className="p-4">Ações</th> : false }
      </tr>
    );
  }
    ...
    return props.clientes?.map((cliente, i) => {
      return (
        ...
        >
          ...
          { exibirAcores ? renderizarAcoes(cliente): false }
        </tr>
      );
    });
  }
